# A z F oo dF es ti va l

A z F oo dF es ti va l is part of the Az-Framework Summer 2.0 activity pack. It registers with Az-Summer2Core for routes, contracts, rewards, validation, and dispatch hooks.
